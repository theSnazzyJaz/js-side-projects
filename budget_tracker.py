...
while True:
    ...
    car_insurance = float(input("Enter your monthly car insurance cost for {month}, {year}: $"))
    health_insurance = float(input("Enter your monthly health insurance cost for {month}, {year}: $"))
    transportation = float(input("Enter your monthly transportation cost for {month}, {year}: $"))
    subscriptions = float(input("Enter your monthly subscriptions cost for {month}, {year}: $"))
    entertainment = float(input("Enter your entertainment cost for {month}, {year}: $"))
    misc = float(input("Enter your monthly miscellaneous expenses for {month}, {year}: $"))


    # Calculate total expenses
    total_expenses = rent + utilities + groceries + car_insurance + health_insurance + transportation + subscriptions + entertainment + misc
 ...
 # Check against goal
    ...
    save_to_file = input("Would you like to save your budget summary to a file? (yes/no): ").lower()
    ...
    if save_to_file == 'yes':
        ...
        with open(filename, "w") as file:
            ...
            file.write(f"Status: {'Reached' if savings >= savings_goal else 'Not Reached'}\n")
        ...
        plt.plot(months_history, savings_history, marker='o', linestyle='-', color='teal')
        ...
        continue_input = input("Would you like to enter another month's data? (yes/no): ").strip().lower()
